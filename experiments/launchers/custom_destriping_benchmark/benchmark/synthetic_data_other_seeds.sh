...
sleep 5
multirun destriping_model/simulation_big_dataset/big_with_struct_nb_weibul_other_seeds/glum_benchmark_v6/v6 &
sleep 5
multirun destriping_model/simulation_big_dataset/big_with_struct_nb_weibul_other_seeds/glum_benchmark_v6/None_init &
sleep 5
