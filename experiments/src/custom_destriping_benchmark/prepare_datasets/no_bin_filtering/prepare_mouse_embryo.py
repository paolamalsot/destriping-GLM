...
output_dir = add_timestamp("results/Visium_HD_Mouse_Embryo_tissue/10x_segmentation__no_bin_filtering")
os.makedirs(output_dir, exist_ok=True)

path_data = "data/Visium_HD_Mouse_Embryo/binned_outputs/square_002um/"
source_img_path = (
