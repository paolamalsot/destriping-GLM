...
data_path = (
    "results/Visium_HD_Mouse_Brain_tissue/stardist_segmentation__24_02_25__18_08_11"
)
sdata = load_spatialAdata(data_path)
sdata.obs["labels_he_str"] = int_to_word(
    sdata.obs["labels_he"].astype(float).fillna(-1).astype(int).values
)
