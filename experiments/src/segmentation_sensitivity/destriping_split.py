...
from src.segmentation_sensitivity.create_sdata import load_split_sdatas
...
def parse_config(original_root, cfg):
    splitting_run_dir = Path(original_root) / cfg.splitting_run_dir
    output_dir = os.getcwd()
    model_cls = cfg.model
    model_args = cfg.model_args
    cell_id_label = cfg.dataset.cell_id_label

    sdatas = load_split_sdatas(splitting_run_dir, project_root=original_root)
    data = sdatas[cfg.p_split]
