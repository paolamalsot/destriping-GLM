...
from src.segmentation_sensitivity.create_sdata import load_subsampled_sdatas
...
def parse_config(original_root, cfg):
    subsampling_run_dir = Path(original_root) / cfg.subsampling_run_dir
    ...
    if cfg.percentage == 1.0:
        ...
        sdatas = load_subsampled_sdatas(subsampling_run_dir, project_root=original_root)
        data = sdatas[cfg.percentage]
