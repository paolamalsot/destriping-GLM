...
class spatialAdata:
    ...
    def scale_he_image(self, mpp=1, crop=True, buffer=150, img_path=None):
        ...
        # kept for bin2cell compatibility
    ...
    def bin2cell(
        ...
        for coord in np.unique(self.coordinate_df.df["coordinate_id"]):
    ...
    def plot_closest_nucl(self, img_key, filter_nuclei=True):
        # important to run after show_labels_adata
    ...
    def get_img(self, img_key):
        if self.is_img_in_memory(img_key):
            ...
            return cv2_utils.load_img(img_path)
