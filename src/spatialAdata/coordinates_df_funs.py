...
def convert_unscaled_limits_basis(adata, limits_basis_A, coordinate_id_basis_A, coordinate_id_basis_B):
    ...
    coords_basis_B = get_unscaled_coordinates(adata, coordinate_id_basis_B)[selector_array, :]
...
def get_limits_pixel_coordinates(img_key, coordinate_id, unscaled_limits, coordinate_df, sdata):
     
     img_coordinate_id, scale_factor = coordinate_df.coordinates_sf_for_img(img_key)
     limits_coords = convert_unscaled_limits_basis(sdata.adata, unscaled_limits, coordinate_id, img_coordinate_id)
