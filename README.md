...
⚡ We use the Python libraries [glum](https://github.com/Quantco/glum) and [tabmat](https://github.com/Quantco/tabmat), which are optimized for fitting generalized linear models with sparse design matrices.
